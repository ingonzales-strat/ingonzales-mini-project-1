  ...
  return (
    <div className="content-center">
        ...
        <div className="md:col-span-1 ">
          <h1 className="font-bold text-6xl sm:text-5xl md:text-6xl ">Hi you!</h1>
          <h1 className="font-bold text-8xl sm:text-7xl md:text-8xl ">I&apos;m <span className="text-blue-500">Niko</span></h1>
          <AdjustedTypeWriter/>
          <Clock/>
        ...
        <div className=" md:col-span-1  text-left">
          <div className=" sm:text-sm md:text-md lg:text-lg md:mr-25 lg:pr-70">
